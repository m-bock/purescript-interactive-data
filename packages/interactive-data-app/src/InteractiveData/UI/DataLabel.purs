...
import InteractiveData.Core (class IDHtml, DataPathSegment(..), DataPath)
...
viewDataLabel :: forall opt html msg. OptArgs (ViewDataLabelOpt msg) opt => IDHtml html => ViewDataLabelCfg -> opt -> html msg
